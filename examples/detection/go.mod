module github.com/razzkumar/imgx/examples/detection

go 1.25.3

require (
	github.com/razzkumar/imgx v1.2.4
	github.com/razzkumar/imgx/detection v0.0.0
)
...
replace (
	...
	github.com/razzkumar/imgx/detection => ../../detection
)
